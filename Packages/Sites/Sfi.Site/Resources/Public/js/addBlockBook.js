function gallery(sSelector){
	...
	addBlock = function(){
		var hiddenBlock = '<div class="clearfix"></div><div class="b-hidden-block"><div class="b-arrow"></div><div class="b-block__img"></div><div class="b-right-block"><p class="b-exhibition__headline">Название выставки</p><p class="b-exhibition__describtion">Строка описания книги</p><p class="b-exhibition__title"></p><div class="b-exhibition__wrapper_button"><a href="#" class="b-exhibition__button">Заказать</a></div></div></div>'
		...
		$(window).resize();
		$('.b-hidden-block').css('display','none');
